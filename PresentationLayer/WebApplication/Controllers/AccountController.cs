...
using PresentationLayer.WebApplication.Models.Identity;
...
namespace WebApplication.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Login(PresentationLayer.WebApplication.Models.Identity.LoginViewModel model, string returnUrl = "")
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    serializeModel.Surname = user.Surname;
